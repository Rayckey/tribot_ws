...
body_vel = val.body_vel(1:300,:);

figure
hold on
plot(times,body_vel(:,2))
plot([0,3],[2.51327412287,2.51327412287],'-')
...
body_ori_vel = val.body_ori_vel(1:300,:);
...
joint_pos = val.joint_pos(1:300,:);

join_vel = val.joint_vel(1:300,:);

join_eff = val.joint_eff(1:300,:);
